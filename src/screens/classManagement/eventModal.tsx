    ...
    >
      ...
      >
        ...
        <Form.Item
          ...
          name='startTime'
          rules={[
            { required: true, message: 'Please input the class start time' }
          ]}
        >
        ...
        <Form.Item
          ...
          name='endTime'
          rules={[
            { required: true, message: 'Please input the class end time' }
          ]}
        >
          <DatePicker showTime format='YYYY-MM-DD HH:mm' />
        </Form.Item>
        ...
        <Form.Item
          ...
          name='teacher'
          rules={[
            { required: true, message: 'Please select a teacher for the class' }
          ]}
        >
          <Input />
        </Form.Item>
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: 'Please input description for the class'
            }
          ]}
        >
          <Input.TextArea />
